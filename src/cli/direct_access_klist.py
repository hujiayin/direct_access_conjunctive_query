...
def main():
    ...
    time_data_file = getattr(args, "time_data_file", "timing_log_access.csv")
    log_file = getattr(args, "timer_log", "exp_time_access.log")
    ...
    tree.direct_access(0)  # warmup call
    ...
    if trial == 1:
        records_file = getattr(args, "records_file", "records_access.csv")
