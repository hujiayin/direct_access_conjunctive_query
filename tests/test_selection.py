...
def smart_join_and_sort(atoms, data, lex_order, free_varaibles):
    ...
    return df_result[leading_cols].reset_index(drop=True)
...
test_s()
# %%
# 2 relations. Full acyclic CQ, complete/partial lex_order, duplicate
free_vars = ['a', 'b', 'c']
atoms = [('P', ('b', 'a')), ('Q', ('c', 'b'))]
...
lex_order = ['u', 'v', 'x', 'y', 'z', 'p']
free_vars = ['u', 'v', 'x', 'y', 'z', 'p']
test_s()
